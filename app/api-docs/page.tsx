...
export const metadata: Metadata = {
  title: "API Docs | Cosmos Upgrades",
  description: "Interactive Cosmos Upgrades API documentation.",
};
        ...
        <div className="hero-content mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-9">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-3 text-4xl font-bold leading-tight text-white md:text-5xl">
              Interactive upgrade data explorer
            </h1>
            <p className="max-w-2xl text-base leading-7 text-slate-300">
              Try the public JSON endpoints, inspect responses, and copy curl or
              jq examples for validator automation.
            </p>
          </div>
        </div>
      </section>
